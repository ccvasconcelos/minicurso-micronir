...
**Número de vagas:** 11 (participantes previamente selecionados).\
...
As sessões da manhã serão entre 09h00 e 12h00.

As sessões da tarde serão entre 14h00 e 17h00.
...
Exercício prático de aquisição de leituras espectrais - Exemplo com algumas espécies CITES (Convenção sobre o Comércio Internacional das Espécies Silvestres Ameaçadas de Extinção):
...
-   Como preparar dos conjuntos de dados para análise
